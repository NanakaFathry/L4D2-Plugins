...
//forward句柄
static Handle g_hCvarViolationForward = null;
...
void CLS_OnModuleStart()
{
	...
	//创建全局forward
	g_hCvarViolationForward = CreateGlobalForward("CLS_OnCvarViolation", 
		ET_Ignore, Param_Cell, Param_String, Param_Float, Param_Float, Param_Float, Param_Cell);
